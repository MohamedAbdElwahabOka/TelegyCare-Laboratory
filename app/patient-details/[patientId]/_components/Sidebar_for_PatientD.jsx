...
function Sidebar_For_PatientD({PatientID,labRegNum}) {
  console.log(labRegNum)
  const searchParams = useSearchParams();

  const PatientDetailsIsActive = searchParams.get('P')=="PatientDetails" ? true : false;
  const AIModelIsActive = searchParams.get('P')=="AImodel" ? true : false;
  const SendResultIsActive = searchParams.get('P')=="SendResult" ? true : false;
  const AIResultIsActive = searchParams.get('P')=="AiResult" ? true : false;
  const PaymentIsActive = searchParams.get('P')=="checkout_Paitent" ? true : false;
    ...
    const navItems = [
        {
          ...
          icon: (
            ...
            >
              <path
                d="M14.1246 5.5C13.9408 7.97828 12.0621 10 9.99955 10C7.93705 10 6.05502 7.97875 5.87455 5.5C5.68705 2.92188 7.51517 1 9.99955 1C12.4839 1 14.3121 2.96875 14.1246 5.5Z"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
              ...
              />
              <path
                d="M10.0001 13C5.92199 13 1.78293 15.25 1.01699 19.4969C0.924645 20.0088 1.21433 20.5 1.75011 20.5H18.2501C18.7864 20.5 19.0761 20.0088 18.9837 19.4969C18.2173 15.25 14.0782 13 10.0001 13Z"
                stroke="currentColor"
                strokeWidth="2"
                strokeMiterlimit="10"
              />
          ...
          link: `/patient-details/${PatientID}?labRegNum=${labRegNum}&P=PatientDetails`,
          text: "Patient Details",
          isActive: PatientDetailsIsActive,
        },
    
        {
          ...
          link: `/AImodel/${PatientID}?labRegNum=${labRegNum}&P=AImodel`,
          text: "AI Model",
          isActive: AIModelIsActive,
        },
        {
          id: 3,
          ...
          link: `/SendResult/${PatientID}?labRegNum=${labRegNum}&P=SendResult`,
          text: "Send Result",
          isActive: SendResultIsActive,
        },
        {
          id: 4,
          icon:(
          ...
          >
          <path 
          d="M29.7 19.3L26.7 16.3C26.3 15.9 25.7 15.9 25.3 16.3L16 25.6V30H20.4L29.7 20.7C30.1 20.3 30.1 19.7 29.7 19.3ZM19.6 28H18V26.4L23 21.4L24.6 23L19.6 28ZM26 21.6L24.4 20L26 18.4L27.6 20L26 21.6ZM10 23H12V25H10V23ZM14 18H18V20H14V18ZM10 18H12V20H10V18ZM14 13H22V15H14V13ZM10 13H12V15H10V13Z" 
          fill="currentColor"/>
          <path d="M7 28V7H10V10H22V7H25V13H27V7C27 5.9 26.1 5 25 5H22V4C22 2.9 21.1 2 20 2H12C10.9 2 10 2.9 10 4V5H7C5.9 5 5 5.9 5 7V28C5 29.1 5.9 30 7 30H12V28H7ZM12 4H20V8H12V4Z" 
          fill="currentColor"/>
          </svg>)
          ,
          link: `/AiResult/${PatientID}?labRegNum=${labRegNum}&P=AiResult`,
          text: "AI Result",
          isActive: AIResultIsActive,
        },
  
        {
          ...
          link: `/checkout_Paitent/${PatientID}?labRegNum=${labRegNum}&P=checkout_Paitent`,
        ...
        },
        {
          ...
          icon: (
            ...
            <path d="M14.1246 5.5C13.9408 7.97828 12.0621 10 9.99955 10C7.93705 10 6.05502 7.97875 5.87455 5.5C5.68705 2.92188 7.51517 1 9.99955 1C12.4839 1 14.3121 2.96875 14.1246 5.5Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M10.0001 13C5.92199 13 1.78293 15.25 1.01699 19.4969C0.924645 20.0088 1.21433 20.5 1.75011 20.5H18.2501C18.7864 20.5 19.0761 20.0088 18.9837 19.4969C18.2173 15.25 14.0782 13 10.0001 13Z" stroke="white" stroke-width="2" stroke-miterlimit="10"/>
          </svg>
          
          ),
          link: `/PatientID/${labRegNum}`,
          text: "Patient List",
    ...
    <aside className={`
        ...
        <div className="min-h-max py-4 border-b border-b-gray-200 dark:border-b-gray-800">
          ...
          <span className={`ml-20 text-slate-100 
                    ${sidebarResized ? "lg:invisible" : ""}`}>TelEgyCare</span>
        </div>
