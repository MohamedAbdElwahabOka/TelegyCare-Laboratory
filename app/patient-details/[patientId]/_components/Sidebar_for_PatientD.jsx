...
function Sidebar_For_PatientD({PatienID,labRegNum}) {
    ...
    const navItems = [
        {
          ...
          link: `/patient-details/${PatienID}?labRegNum=${labRegNum}`,
    ...
    
        {
          ...
          link: `/AImodel/${PatienID}?labRegNum=${labRegNum}`,
          text: "AI Model",
          isActive: false,
        },
        {
          ...
          link: `/SendResult/${PatienID}?labRegNum=${labRegNum}`,
          text: "Send Result",
          isActive: false,
        },
        {
          ...
          ,
          link: `/AiResult/${PatienID}?labRegNum=${labRegNum}`,
          text: "AI Result",
          isActive: false,
        },
  ...
  
        {
          ...
          ,
          link: `/checkout_Paitent/${PatienID}?labRegNum=${labRegNum}`,
