    ...
    const navItems = [
        {
          ...
          link: `/patient-details/${PatientID}?labRegNum=${labRegNum}`,
    ...
    
        {
          ...
          link: `/AImodel/${PatientID}?labRegNum=${labRegNum}`,
          text: "AI Model",
          isActive: false,
        },
        {
          ...
          link: `/SendResult/${PatientID}?labRegNum=${labRegNum}`,
          text: "Send Result",
          isActive: false,
        },
        {
          ...
          ,
          link: `/AiResult/${PatientID}?labRegNum=${labRegNum}`,
          text: "AI Result",
          isActive: false,
        },
  ...
  
        {
          ...
          ,
          link: `/checkout_Paitent/${PatientID}?labRegNum=${labRegNum}`,
