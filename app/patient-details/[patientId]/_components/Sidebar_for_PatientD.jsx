...
function Sidebar_For_PatientD({PatienID}) {
  console.log(PatienID)
    ...
    const navItems = [
  ...
  
        {
          ...
          ,
          link: `/checkout_Paitent/${PatienID}`,
