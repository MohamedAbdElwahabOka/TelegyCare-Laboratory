...
function Sidebar({data}) {
  ...
  const PatientIdIsActive = searchParams.get('P')=="PatientID" ? true : false;
  const PaymentActive = searchParams.get('P')=="checkout" ? true : false;
    ...
    const navItems = [
      {
        ...
        icon: (
          ...
          link: `/PatientID/${data}?P=PatientID`,
          text: "Patient ID",
